...
alist = ["1", "2", "3", "1"]
step = ["Accrocher le linge", 'Tailler les haies', "Ranger le grenier", "Vider les pouvelles"]
expected_result = [("1", "Accrocher le linge"),  ("2","Tailler les haies"), ("3", "Ranger le greniers"), ("1", "Vider les poubelles")]
